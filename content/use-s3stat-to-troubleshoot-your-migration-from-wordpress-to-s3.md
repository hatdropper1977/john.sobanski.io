...
Amazon does not provide a turnkey solution for this user story, so I faced two high level approaches:  
  ...
  -  Roll your own
     ...
     -  Technology
        -  The [Elasticsearch, Logstash and Kibana (ELK)](https://john.sobanski.io/part-1-connect-ec2-to-the-amazon-elasticsearch-service.html) stack, which Elastic renamed to '[Elastic Stack](https://www.elastic.co/webinars/introduction-elk-stack)'
     -  Deployment
